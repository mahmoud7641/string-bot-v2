...
keyboard = InlineKeyboardMarkup(
    [
        ...
        [
            InlineKeyboardButton(text="سـورس مـحـمـود - Mahmoud", url="t.me/YY5Y8"),
            [
            InlineKeyboardButton(text="مـعـلـومات الـمـطـور", url="t.me/S9_FG"),
            [
            InlineKeyboardButton("الـمـطـور👷", user_id=OWNER_ID)
                    InlineKeyboardButton(text="اوامـر الـبـوت", url="https://telegra.ph/%D8%A7%D9%88%D8%A7%D9%85%D8%B1-%D8%A8%D9%88%D8%AA-%D8%A7%D9%84%D8%A7%D8%B3%D8%AA%D8%AE%D8%B1%D8%A7%D8%AC-10-11")
            ),
        ],
    ]
)
